...
## The color labeling of the plot lines is the default matplotlib plot coloring.
...
## To do the plotting. gnuplot plots the columns of solution.dat 
...
##                  1.1, added plotting, as of Mon Mar 14, 2016  5:52 AM
